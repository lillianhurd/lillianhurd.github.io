...
let animations = [];
let scoreIncreased;
let squish = new Tone.Player('assets/splat.wav').toDestination();
let win = new Tone.Player('assets/wow.wav').toDestination();
let lose = new Tone.Player('assets/aww.wav').toDestination();
let music;
...
function preload() {
  ...
  music = new Tone.Player('assets/sound1.mp3').toDestination();
  music.loop = true;
...
function draw() {
  switch(game.state) {
    ...
    case GameState.GameOver:
      ...
      text("High Score: " + game.maxScore,200,320);
      break;
